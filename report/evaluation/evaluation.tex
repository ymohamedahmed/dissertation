...
% \begin{figure}[H]
%     \centering
%     \scalebox{0.5}{\input{bayesian.pgf}}
...
\begin{figure}[H]
    ...
    \subfloat[\textit{Mean absolute error per distance}]{\scalebox{0.5}{\input{evaluation/dist_error.pgf}}}
    \quad
    \subfloat[\textit{Mean absolute error per class}]{\scalebox{0.55}{\input{evaluation/movement_error.pgf}}}
    \quad
    \subfloat[\textit{Mean ground truth heart rate per class}]{\scalebox{0.55}{\input{evaluation/movement_perc_error.pgf}}}
\end{figure}
...
for errors in the ground truth. A perfect signal, that is, a signal where the only components present in $F(\omega)$ correspond to the heart rate, will have a noise value of $1$.
\begin{equation*}
...
\begin{figure}[H]
    \centering
    \subfloat{\scalebox{0.6}{\input{evaluation/NoiseStationary.pgf}}}%
    \subfloat{\scalebox{0.6}{\input{evaluation/NoiseStarjumps.pgf} }}%
    \subfloat{\scalebox{0.6}{\input{evaluation/NoiseJogging.pgf} }}%
...
\begin{figure}[H]
    \centering
    \subfloat{\scalebox{0.5}{\input{evaluation/Noise-with-exer.pgf}}}
    \subfloat{\scalebox{0.5}{\input{evaluation/Noise-with-exer-perc.pgf}}}
    \subfloat{\scalebox{0.5}{\input{evaluation/Noise-with-exer-squared.pgf}}}
...
\begin{figure}[H]
    \centering
    \subfloat{\scalebox{0.5}{\input{evaluation/std_error.pgf}}}
    \subfloat{\scalebox{0.5}{\input{evaluation/std_perc.pgf}}}
    \subfloat{\scalebox{0.5}{\input{evaluation/std_rmse.pgf}}}
...
\begin{figure}
    \centering
    \scalebox{0.6}{\input{evaluation/mahnob.pgf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.6}{\input{evaluation/fidelity.pgf}}
