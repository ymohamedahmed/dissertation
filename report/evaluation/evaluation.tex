...
\begin{figure}[H]
    \centering
    \subfloat[\textit{The experimental redetection rate, $R/W$ and theoretical upper bound}]{\scalebox{0.6}{\input{evaluation/redect.pgf}}}
    \quad
    \subfloat[\textit{The mean time to a process a single frame for both face detection and face tracking.}]{\scalebox{0.5}{\input{evaluation/tracking_time.pgf}}}
\end{figure}
\noindent
...
Using a null hypothesis that both face tracking and face detection have an identical expected error, an independent two sample t-test is conducted. The p-values over each type of video tested are reported.
...
\begin{figure}
    \centering
    \scalebox{0.5}{\input{evaluation/precomputed.pgf}}
...
\begin{figure}[H]
    \centering
    \subfloat[\textit{Frequency of measurements across genders}]{\scalebox{0.6}{\input{evaluation/gender_freq.pgf}}}
    \quad
    \subfloat[\textit{Mean absolute error by gender}]{\scalebox{0.6}{\input{evaluation/gender_error.pgf}}}
    \quad
    \subfloat[\textit{Frequency of measurements per skin tone}]{\scalebox{0.6}{\input{evaluation/skin_tone.pgf}}}
    \quad
    \subfloat[\textit{Mean absolute error by skin tone}]{\scalebox{0.6}{\input{evaluation/skin_error.pgf}}}
...
\begin{table}[H]
    \centering
    % \subfloat[Mean a]{\scalebox{0.7}{\input{evaluation/skin_tone_error_table.tex}}}
    % \qquad
    \scalebox{0.7}{\input{evaluation/skin_tone_p_table.tex}}
...
\begin{figure}[H]
    \centering
    % \subfloat[\textit{Frequency of measurements across distances}]{\scalebox{0.5}{\input{evaluation/dist_freq.pgf}}}
    \subfloat[\textit{Mean absolute error per distance}]{\scalebox{0.6}{\input{evaluation/dist_error.pgf}}}
    \quad
    \subfloat[\textit{Mean absolute error per class}]{\scalebox{0.6}{\input{evaluation/movement_error.pgf}}}
    \quad
    \subfloat[\textit{Mean ground truth heart rate per class}]{\scalebox{0.6}{\input{evaluation/movement_perc_error.pgf}}}
\end{figure}
...
% \begin{figure}[H]
%     \centering
%     \subfloat[\textit{Frequency of measurements across exercise classes}]{\scalebox{0.55}{\input{evaluation/movement_freq.pgf}}}
%     \label{fig:move_err}
% \end{figure}
...
\begin{wrapfigure}{l}{0.44\textwidth}
   \centering 
   \scalebox{0.6}{
   \input{evaluation/movement_euclidean.pgf}}
...
\begin{figure}[H]
    \centering
    \subfloat{\scalebox{0.8}{\input{evaluation/NoiseStationary.pgf}}}%
    \subfloat{\scalebox{0.8}{\input{evaluation/NoiseStarjumps.pgf} }}%
    \subfloat{\scalebox{0.8}{\input{evaluation/NoiseJogging.pgf} }}%
...
\begin{figure}[H]
    \centering
    \subfloat{\scalebox{0.6}{\input{evaluation/Noise-with-exer.pgf}}}
    \subfloat{\scalebox{0.6}{\input{evaluation/Noise-with-exer-perc.pgf}}}
    \subfloat{\scalebox{0.6}{\input{evaluation/Noise-with-exer-squared.pgf}}}
...
\begin{figure}[H]
    \centering
    \subfloat{\scalebox{0.6}{\input{evaluation/std_error.pgf}}}
    \subfloat{\scalebox{0.6}{\input{evaluation/std_perc.pgf}}}
    \subfloat{\scalebox{0.6}{\input{evaluation/std_rmse.pgf}}}
...
\begin{figure}
    \centering
    \scalebox{0.7}{\input{evaluation/mahnob.pgf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.7}{\input{evaluation/fidelity.pgf}}
