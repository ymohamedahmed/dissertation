...
MAHNOB \cite{Mahnob}, however, only consists of videos where the participants are stationary and at a fixed, close distance to the camera, this alone, would not be adeqeuate for testing many aspects of the project.
...
\begin{figure}[H]
    \centering
    \input{evaluation/tracking_time.pgf}
%    \caption{} 
\end{figure}
