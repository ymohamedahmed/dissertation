...
% \begin{figure}[H]
%     \centering
%     \subfloat[]{\scalebox{0.7}{\input{evaluation/skin_tone_error_table.tex}}}
%     \qquad
%     \subfloat[]{\scalebox{0.7}{\input{evaluation/skin_tone_p_table.tex}}}
% \end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[]{\scalebox{0.6}{\input{evaluation/dist_freq.pgf}}}
    \subfloat[]{\scalebox{0.6}{\input{evaluation/dist_error.pgf}}}
\end{figure}
