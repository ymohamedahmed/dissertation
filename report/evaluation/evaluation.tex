...
\subsubsection{Impact of gender and skin tone}
% NEED TO SAY THIS IS ONLY FOR MAHNOB
\begin{figure}[H]
    \centering
    \subfloat[]{\scalebox{0.7}{\input{evaluation/gender_freq.pgf}}}
    \qquad
    \subfloat[]{\scalebox{0.7}{\input{evaluation/gender_error.pgf}}}
\end{figure}

\begin{figure}[H]
    \centering
    \subfloat[]{\scalebox{0.7}{\input{evaluation/skin_tone.pgf}}}
    \qquad
    \subfloat[]{\scalebox{0.7}{\input{evaluation/skin_error.pgf}}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[]{\scalebox{0.6}{\input{evaluation/movement_freq.pgf}}}
    \subfloat[]{\scalebox{0.6}{\input{evaluation/movement_error.pgf}}}
\end{figure}
