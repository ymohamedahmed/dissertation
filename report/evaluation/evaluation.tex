...
\begin{figure}[H]
    \centering
    \scalebox{0.7}{\input{bayesian.pgf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.7}{\input{evaluation/precomputed.pgf}}
...
\begin{figure}[H]
    \centering
    \subfloat[\textit{Frequency of measurements across genders}]{\scalebox{0.7}{\input{evaluation/gender_freq.pgf}}}
    \qquad
    \subfloat[\textit{Mean absolute error by gender}]{\scalebox{0.7}{\input{evaluation/gender_error.pgf}}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[\textit{Frequency of measurements per skin tone}]{\scalebox{0.7}{\input{evaluation/skin_tone.pgf}}}
    \qquad
    \subfloat[\textit{Mean absolute error by skin tone}]{\scalebox{0.7}{\input{evaluation/skin_error.pgf}}}
\end{figure}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \subfloat[\textit{Frequency of measurements across distances}]{\scalebox{0.6}{\input{evaluation/dist_freq.pgf}}}
...
\begin{figure}[H]
    \centering
    \subfloat{\scalebox{0.5}{\input{evaluation/NoiseStationary.pgf}}}%
    \subfloat{\scalebox{0.5}{\input{evaluation/NoiseStar.pgf} }}%
    \quad
    \subfloat{\scalebox{0.5}{\input{evaluation/NoiseJogging.pgf} }}%
