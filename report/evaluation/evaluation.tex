...
when its results cannot be trusted. To such end, evaluating the project, in this vein, is paramount. I proceed by defining metrics to quantify this and end by comparing to a wrist-based PPG sensor.
