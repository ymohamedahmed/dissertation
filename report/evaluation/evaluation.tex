...
% If you use beamer only pass "xcolor=table" option, i.e. \documentclass[xcolor=table]{beamer}
    ...
    \multicolumn{1}{c|}{\textbf{Exercise}} & \textbf{Distance} & \textbf{MAE} & \textbf{RMSE} & \textbf{MAE} & \textbf{RMSE} & \multicolumn{1}{c|}{\textbf{$t_{MAE}$}} & \multicolumn{1}{c|}{\textbf{$p_{MAE}$}} & \multicolumn{1}{c|}{\textbf{$t_{RMSE}$}} & \textbf{$p_{RMSE}$} \\ \hline
