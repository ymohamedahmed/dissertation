...
\begin{figure}[H]
    \centering
    \subfloat[\textit{Raw video signal}]{\scalebox{0.6}{\input{implementation/ica_0.pgf}}}
    \subfloat[\textit{ICA Component 1}]{\scalebox{0.6}{\input{implementation/ica_1.pgf}}}

    \subfloat[\textit{ICA Component 2}]{\scalebox{0.6}{\input{implementation/ica_2.pgf}}}
    \subfloat[\textit{ICA Component 3}]{\scalebox{0.6}{\input{implementation/ica_3.pgf}}}
\end{figure}
% In 
