...
\begin{figure}[H]
    ...
    %     \centering
    %     \includegraphics[width=0.3\textwidth]{implementation/c.jpg}
    % \end{subfigure}%
    % \begin{subfigure}{.5\textwidth}
    %     \centering
    %     \includegraphics[width=0.3\textwidth]{implementation/interval.jpg}
    % \end{subfigure}%
...
By instead, representing each component of the skin tone as an integer and by rounding the Euclidean distance to the nearest integer, the distributions are precomputed 
...
using precomputed distributions achieves a 2x speedup in the overall pipeline (see Appendix.).

\begin{figure}[H]
    \centering
    % Have an image from face to -> pixels in colour space on a graph with classification ->  to what classification looks like
    % \includegraphics[width=0.5\textwidth]{example-image-a}
    \subfloat[Original image]{{\includegraphics[width=7cm]{implementation/c.jpg} }}%
    \qquad
    \subfloat[Proposed]{{\includegraphics[width=7.2cm]{implementation/hmap-763-763.png} }}%

    \subfloat[Original image]{{\includegraphics[width=7cm]{implementation/c-2.jpg} }}%
    \qquad
    \subfloat[Proposed]{{\includegraphics[width=7.2cm]{implementation/hmap-678-678.png} }}%
