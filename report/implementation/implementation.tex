...
The best choice of the threshold value is not obvious. Since the main goal of the algorithm is to minimise the effect of non-skin pixels, we instead take a weighted 
...
By instead, representing each component of the skin tone an integer and by rounding the Euclidean distance to the nearest integer, the distributions are precomputed 
...
\begin{figure}[H]
   ...
   \caption{An example result from the described skin detection algorithm} 
\end{figure}
