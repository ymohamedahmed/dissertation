...
\begin{itemize}
    \item Since it encodes no notion of location with respect to other pixels, a lone pixel in the corner that has a similar colour to the skin tone is considered the same as a pixel surrounded by such colours
    \item There's no rigorous means for deciding the number of clusters to expect in the data
\end{itemize}
