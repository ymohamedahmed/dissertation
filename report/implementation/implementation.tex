...
\begin{itemize}
    \item Identifying the pulse signal: given the noisy time series of observed colours for each frame, identify the signal corresponding to the pulse
...
The PCA approach comes with the benefit of returning 
...
\begin{figure}[!h]
    % Add an image showing how in noisy Fourier transforms the HR is not just highest peak
    \includegraphics[width=\textwidth]{example-image-a}
   \caption{An example of the split peak issue} 
\end{figure}
